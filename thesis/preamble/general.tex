...
\usepackage[unicode=true,psdextra]{hyperref}                 % References package
    ...
    \AddToShipoutPicture*{
        \put(400,0){
            \parbox[b][\paperheight]{\paperwidth}{%
               % {\transparent{}\includegraphics[trim=18mm 0 0 0,width=0.66\textwidth]{rulogogray}}
               {\includegraphics[trim=18mm 0 0 0,width=0.66\textwidth]{rulogogray}}
                \vspace*{3.2cm}
            }
        }
       % \put(0,0){%
